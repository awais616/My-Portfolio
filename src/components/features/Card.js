...
const Card = ({title, des, icon}) => {
  return (
    <div id='cards' className='w-full px-8 h-100 py-6 rounded-lg shadow-shadowOne flex items-center group hover:bg-gradient-to-b hover:from-black hover:to-[#1e2024]
