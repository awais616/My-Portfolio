  ...
  return (
    <section id='contacts' className='w-full py-20 border-b-[1px] border-b-black'>
        ...
        <div className='w-full'>
            ...
            {/* cantact left */}
                <div id='contactdiv' className='w-full lgl:w-[35%] bg-gradient-to-r from-[#1e2024] to-[#23272b]
                    p-2 lgl:p-8 rounded-lg flex flex-col gap-8 justify-center'>
                    <img className='w-full p-10 h-[400px] object-cover rounded-lg mb-2' 
...
{/* contact Right */}
                ...
                <div id='contactdiv' className='w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b]
                flex flex-col gap-8 p-4 lgl:p-8 rounded-lg'>
                    <form action="" className='w-full flex flex-col gap:4 lgl:gap-6 p-2 lgl:p-5'>
...
{/* Error message */}
{
                        ...
                        <div className='w-full flex flex-col lgl:flex-row gap-10'>
                            ...
                            w-full h-12 rounded-lg border-b-[1px] border-b-gray-600 bg-[#191b1e] text-ligtText
                            px-4 active:outline-none focus-visible:outline-designColor focus-visible:border-b-transparent
                            duration-300 outline-none mt-4`} type="text" />
                            </div>
                        </div>


                        <div className='w-full flex flex-col '>
                        <p className='text-sm text-gray-400 tracking-wide gap-4 mt-4 uppercase'>email</p>
                            ...
                            px-4 active:outline-none focus-visible:outline-designColor focus-visible:border-b-transparent
                            duration-300 outline-none mt-4`} type="email"/>
                        </div>
                      
                        <div className='w-full flex flex-col gap-4'>
                        <p className='text-sm text-gray-400 tracking-wide uppercase mt-4'>subject</p>
                        ...
                        <div className='w-full flex flex-col gap-4'>
                        <p className='text-sm text-gray-400 tracking-wide uppercase mt-4'>your message</p>
